...
RUN apt-get install -y nodejs libc6 libgconf2-4 libxss1 libbz2-dev wget libcurl4-gnutls-dev libpng-dev libpq-dev libedit-dev libxml2-dev libmemcached-dev libxslt-dev
RUN wget http://ftp.debian.org/debian/pool/main/g/glibc/libc6_2.37-15_amd64.deb && ls -al && dpkg -i libc6_2.37-15_amd64.deb
