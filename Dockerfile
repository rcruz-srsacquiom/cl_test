...
RUN  cat /etc/apt/sources.list && apt-get install -y nodejs libc6 libc6-dev libc-dev-bin libgconf2-4 libxss1 libbz2-dev wget libcurl4-gnutls-dev libpng-dev libpq-dev libedit-dev libxml2-dev libmemcached-dev libxslt-dev
