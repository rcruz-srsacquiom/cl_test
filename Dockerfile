...
RUN curl -O http://ftp.mx.debian.org/debian/pool/main/g/glibc/libc6-udeb_2.28-10+deb10u1_amd64.udeb && ls -al && dpkg -i --force overwrite ./libc6-udeb_2.28-10+deb10u1_amd64.udeb
